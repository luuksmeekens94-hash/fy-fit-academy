...
async function main() {
  ...
  const createdCourse = await prisma.course.create({
    data: {
      ...
      accreditationActivityId: demoSeed.course.accreditationActivityId,
      providerName: demoSeed.course.providerName,
      providerSignatureName: demoSeed.course.providerSignatureName,
