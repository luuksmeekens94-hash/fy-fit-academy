...
async function main() {
  ...
  await prisma.evaluationForm.create({
    data: {
      ...
      questions: {
        create: [
          { label: "Algehele indruk van de e-learning", type: "SCALE_1_10", order: 1, isRequired: true },
          { label: "Relevantie van het onderwerp voor jouw werk", type: "SCALE_1_10", order: 2, isRequired: true },
          { label: "Gebruiksgemak en toegankelijkheid van de leeromgeving", type: "SCALE_1_10", order: 3, isRequired: true },
          { label: "De inhoud was duidelijk en begrijpelijk.", type: "SCALE_1_5", order: 4, isRequired: true },
          { label: "De doorlopende casus (Sanne) was herkenbaar en hielp om de theorie aan de praktijk te koppelen.", type: "SCALE_1_5", order: 5, isRequired: true },
          { label: "De leerdoelen waren helder geformuleerd en haalbaar.", type: "SCALE_1_5", order: 6, isRequired: true },
          { label: "De paradigmaverschuiving van structureel denken naar weefselhomeostase werd helder overgebracht.", type: "SCALE_1_5", order: 7, isRequired: true },
          { label: "Het onderscheid tussen patellofemorale pijn en patellatendinopathie was goed uitgelegd.", type: "SCALE_1_5", order: 8, isRequired: true },
          { label: "Welke module vond je het meest waardevol en waarom?", type: "TEXT", order: 9, isRequired: false },
          { label: "Welke module vond je het minst waardevol en waarom?", type: "TEXT", order: 10, isRequired: false },
          { label: "Ik kan de opgedane kennis toepassen bij de diagnostiek en behandeling van patiënten met anterieure kniepijn.", type: "SCALE_1_5", order: 11, isRequired: true },
          { label: "Ik kan de DSDT en de LLROM-test uitvoeren en de uitkomsten interpreteren.", type: "SCALE_1_5", order: 12, isRequired: true },
          { label: "Ik voel mij zekerder in het opstellen van een gefaseerd behandelplan binnen de grenzen van de weefselhomeostase.", type: "SCALE_1_5", order: 13, isRequired: true },
          { label: "Ik kan een patiënt in begrijpelijke taal uitleggen waarom de knie ‘niet stuk, wel van slag’ is.", type: "SCALE_1_5", order: 14, isRequired: true },
          { label: "Geef een voorbeeld van hoe je de opgedane inzichten gaat toepassen in je dagelijkse werk.", type: "TEXT", order: 15, isRequired: false },
          { label: "De afwisseling tussen theorie, video en opdrachten was stimulerend.", type: "SCALE_1_5", order: 16, isRequired: true },
          { label: "De community-opdrachten (casusreflectie, praktijkopdracht, behandelplan en klinische samenvatting) hebben mijn klinisch redeneren verdiept.", type: "SCALE_1_5", order: 17, isRequired: true },
          { label: "De video over de Lower Limb Range of Motion-test (module 2) was ondersteunend en duidelijk.", type: "SCALE_1_5", order: 18, isRequired: true },
          { label: "De video met de klinische take-home messages (module 4) versterkte de leerervaring.", type: "SCALE_1_5", order: 19, isRequired: true },
          { label: "De toetsvragen per module sloten goed aan bij de behandelde stof.", type: "SCALE_1_5", order: 20, isRequired: true },
          { label: "Welke werkvorm vond je het meest effectief en waarom?", type: "TEXT", order: 21, isRequired: false },
          { label: "Welke werkvorm vond je minder effectief en waarom?", type: "TEXT", order: 22, isRequired: false },
          { label: "Wat heeft deze e-learning veranderd in jouw manier van kijken naar patellofemorale pijn?", type: "TEXT", order: 23, isRequired: false },
          { label: "Welke inzichten of benaderingen neem je vooral mee uit deze scholing?", type: "TEXT", order: 24, isRequired: false },
          { label: "Heb je nog suggesties om deze e-learning verder te verbeteren?", type: "TEXT", order: 25, isRequired: false },
          { label: "Zijn er onderwerpen die je miste of waar je graag meer verdieping in had gezien?", type: "TEXT", order: 26, isRequired: false },
          { label: "Zou je deze e-learning aanraden aan collega’s?", type: "YES_NO", order: 27, isRequired: true },
          { label: "Namelijk / toelichting", type: "TEXT", order: 28, isRequired: false },
        ],
      },
    },
  });
