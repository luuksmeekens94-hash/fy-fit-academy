...
async function main() {
  ...
  const seededCourse = await prisma.course.create({
    data: {
      ...
      accreditationActivityId: lmsSeed.course.accreditationActivityId,
      providerName: lmsSeed.course.providerName,
      providerSignatureName: lmsSeed.course.providerSignatureName,
