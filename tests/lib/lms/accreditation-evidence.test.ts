...
test("buildAccreditationEvidenceExport renders a Kwaliteitshuis-ready markdown dossier", () => {
  const checklist = buildAccreditationChecklist({
    ...
    accreditationActivityId: completeCourse.accreditationActivityId,
    providerName: completeCourse.providerName,
    providerSignatureName: completeCourse.providerSignatureName,
