...
export function AcademyLessonSidebar({ sidebar }: AcademyLessonSidebarProps) {
  return (
    <aside className="card-surface rounded-[24px] p-5">
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[var(--teal)]">Jouw voortgang</p>
      <div className="mt-4">
      ...
      <div className="mt-6 space-y-3">
        <Link
          ...
          className="block rounded-2xl border border-[var(--border)] bg-white px-4 py-3 text-sm font-semibold text-slate-900 transition hover:border-[var(--teal)]"
        >
        ...
        {sidebar.previousLesson ? (
          <Link
            ...
            className="block rounded-2xl border border-[var(--border)] bg-white px-4 py-3 text-sm text-[var(--foreground)] transition hover:border-[var(--teal)]"
          >
