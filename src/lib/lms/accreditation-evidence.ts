...
export function buildAccreditationEvidenceExport(
  ...
  return [
    ...
    bullet([
      ...
      `Accreditatie-/activiteit-ID: ${formatOptional(course.accreditationActivityId)}`,
      `Aanbieder: ${formatOptional(course.providerName)}`,
      `Handtekening/ondertekenaar deelnamebewijs: ${formatOptional(course.providerSignatureName)}`,
